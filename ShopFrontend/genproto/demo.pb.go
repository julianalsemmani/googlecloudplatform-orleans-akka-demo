...
var file_demo_proto_goTypes = []any{
	...
	(*ListRecommendationsRequest)(nil),     // 6: shop.ListRecommendationsRequest
	(*ListRecommendationsResponse)(nil),    // 7: shop.ListRecommendationsResponse
	(*Product)(nil),                        // 8: shop.Product
	(*ListProductsResponse)(nil),           // 9: shop.ListProductsResponse
	(*GetProductRequest)(nil),              // 10: shop.GetProductRequest
	(*SearchProductsRequest)(nil),          // 11: shop.SearchProductsRequest
	(*SearchProductsResponse)(nil),         // 12: shop.SearchProductsResponse
	(*GetQuoteRequest)(nil),                // 13: shop.GetQuoteRequest
	(*GetQuoteResponse)(nil),               // 14: shop.GetQuoteResponse
	(*ShipOrderRequest)(nil),               // 15: shop.ShipOrderRequest
	(*ShipOrderResponse)(nil),              // 16: shop.ShipOrderResponse
	(*Address)(nil),                        // 17: shop.Address
	(*Money)(nil),                          // 18: shop.Money
	(*GetSupportedCurrenciesResponse)(nil), // 19: shop.GetSupportedCurrenciesResponse
	(*CurrencyConversionRequest)(nil),      // 20: shop.CurrencyConversionRequest
	(*CreditCardInfo)(nil),                 // 21: shop.CreditCardInfo
	(*ChargeRequest)(nil),                  // 22: shop.ChargeRequest
	(*ChargeResponse)(nil),                 // 23: shop.ChargeResponse
	(*OrderItem)(nil),                      // 24: shop.OrderItem
	(*OrderResult)(nil),                    // 25: shop.OrderResult
	(*SendOrderConfirmationRequest)(nil),   // 26: shop.SendOrderConfirmationRequest
	(*PlaceOrderRequest)(nil),              // 27: shop.PlaceOrderRequest
	(*PlaceOrderResponse)(nil),             // 28: shop.PlaceOrderResponse
	(*AdRequest)(nil),                      // 29: shop.AdRequest
	(*AdResponse)(nil),                     // 30: shop.AdResponse
	(*Ad)(nil),                             // 31: shop.Ad
}
var file_demo_proto_depIdxs = []int32{
	...
	18, // 2: shop.Product.price_usd:type_name -> shop.Money
	8,  // 3: shop.ListProductsResponse.products:type_name -> shop.Product
	8,  // 4: shop.SearchProductsResponse.results:type_name -> shop.Product
	17, // 5: shop.GetQuoteRequest.address:type_name -> shop.Address
	0,  // 6: shop.GetQuoteRequest.items:type_name -> shop.CartItem
	18, // 7: shop.GetQuoteResponse.cost_usd:type_name -> shop.Money
	17, // 8: shop.ShipOrderRequest.address:type_name -> shop.Address
	0,  // 9: shop.ShipOrderRequest.items:type_name -> shop.CartItem
	18, // 10: shop.CurrencyConversionRequest.from:type_name -> shop.Money
	18, // 11: shop.ChargeRequest.amount:type_name -> shop.Money
	21, // 12: shop.ChargeRequest.credit_card:type_name -> shop.CreditCardInfo
	0,  // 13: shop.OrderItem.item:type_name -> shop.CartItem
	18, // 14: shop.OrderItem.cost:type_name -> shop.Money
	18, // 15: shop.OrderResult.shipping_cost:type_name -> shop.Money
	17, // 16: shop.OrderResult.shipping_address:type_name -> shop.Address
	24, // 17: shop.OrderResult.items:type_name -> shop.OrderItem
	25, // 18: shop.SendOrderConfirmationRequest.order:type_name -> shop.OrderResult
	17, // 19: shop.PlaceOrderRequest.address:type_name -> shop.Address
	21, // 20: shop.PlaceOrderRequest.credit_card:type_name -> shop.CreditCardInfo
	25, // 21: shop.PlaceOrderResponse.order:type_name -> shop.OrderResult
	31, // 22: shop.AdResponse.ads:type_name -> shop.Ad
	1,  // 23: shop.CartService.AddItem:input_type -> shop.AddItemRequest
	3,  // 24: shop.CartService.GetCart:input_type -> shop.GetCartRequest
	2,  // 25: shop.CartService.EmptyCart:input_type -> shop.EmptyCartRequest
	6,  // 26: shop.RecommendationService.ListRecommendations:input_type -> shop.ListRecommendationsRequest
	5,  // 27: shop.ProductCatalogService.ListProducts:input_type -> shop.Empty
	10, // 28: shop.ProductCatalogService.GetProduct:input_type -> shop.GetProductRequest
	11, // 29: shop.ProductCatalogService.SearchProducts:input_type -> shop.SearchProductsRequest
	13, // 30: shop.ShippingService.GetQuote:input_type -> shop.GetQuoteRequest
	15, // 31: shop.ShippingService.ShipOrder:input_type -> shop.ShipOrderRequest
	5,  // 32: shop.CurrencyService.GetSupportedCurrencies:input_type -> shop.Empty
	20, // 33: shop.CurrencyService.Convert:input_type -> shop.CurrencyConversionRequest
	22, // 34: shop.PaymentService.Charge:input_type -> shop.ChargeRequest
	26, // 35: shop.EmailService.SendOrderConfirmation:input_type -> shop.SendOrderConfirmationRequest
	27, // 36: shop.CheckoutService.PlaceOrder:input_type -> shop.PlaceOrderRequest
	29, // 37: shop.AdService.GetAds:input_type -> shop.AdRequest
	5,  // 38: shop.CartService.AddItem:output_type -> shop.Empty
	4,  // 39: shop.CartService.GetCart:output_type -> shop.Cart
	5,  // 40: shop.CartService.EmptyCart:output_type -> shop.Empty
	7,  // 41: shop.RecommendationService.ListRecommendations:output_type -> shop.ListRecommendationsResponse
	9,  // 42: shop.ProductCatalogService.ListProducts:output_type -> shop.ListProductsResponse
	8,  // 43: shop.ProductCatalogService.GetProduct:output_type -> shop.Product
	12, // 44: shop.ProductCatalogService.SearchProducts:output_type -> shop.SearchProductsResponse
	14, // 45: shop.ShippingService.GetQuote:output_type -> shop.GetQuoteResponse
	16, // 46: shop.ShippingService.ShipOrder:output_type -> shop.ShipOrderResponse
	19, // 47: shop.CurrencyService.GetSupportedCurrencies:output_type -> shop.GetSupportedCurrenciesResponse
	18, // 48: shop.CurrencyService.Convert:output_type -> shop.Money
	23, // 49: shop.PaymentService.Charge:output_type -> shop.ChargeResponse
	5,  // 50: shop.EmailService.SendOrderConfirmation:output_type -> shop.Empty
	28, // 51: shop.CheckoutService.PlaceOrder:output_type -> shop.PlaceOrderResponse
	30, // 52: shop.AdService.GetAds:output_type -> shop.AdResponse
