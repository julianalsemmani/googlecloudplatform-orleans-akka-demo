...
namespace OrleansShopDemo.Grains.ProductCatalog
{
    public class ProductCatalogGrain : Grain, IProductCatalogGrain
    {
        ...
        {
            return Task.FromResult(products.Find(p => p.Id == request.Id) ?? throw new RpcException(new Status(StatusCode.FailedPrecondition, $"No product with id={request.Id}")));
        }
